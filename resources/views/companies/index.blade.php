            ...
            columns: [
                ...
                { data: 'company_reg_number' },
                {
                    ...
                    render: function(data) {
                        return data ? '<img src="' + "{{ Storage::url('') }}" + data + '" width="50" alt="Logo">' : 'No Logo';
                    }
                },
                {
                    data: null,
                    render: function(data, type, row) {
                        return '<a href="' + '{{ route('companies.edit', ':id') }}'.replace(':id', row.id) + '" class="btn btn-sm btn-primary">Edit</a> ' +
